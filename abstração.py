...
A ideia é trabalhar no nível mais genérico e deixar as classes
mais específicas implementam os detalhes.

'''

from abc import ABC, abstractmethod

#Classe aberta (não pode ser instanciada diretamente)
class Pessoa(ABC):
